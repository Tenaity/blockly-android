...
public class BluetoothLeService {
    ...
    private BluetoothLeService() {
        ...
        if (!value) Log.e("e","蓝牙适配器adapter初始化失败!!!"); //khởi tạo adapter bluetooth không thành công
    }
    ...
    /**
     * 初始化bluetooth adapter // khởi tạo bluetooth adapter
     *
     * @return 为null返回false // trả lại false nếu null
     */
    ...
    /**
     * 启用或者禁用通知\标志返回特性 true, if the requested notification status was set successfully // thông báo trạng thái
     *
     * @param characteristic 蓝牙特征对象 // loại bluetooth
     * @param enabled        是否允许 // cho phép
     * @return 设置成功或失败  // trả kết quả trạng thái
     */
    ...
    /**
     * 往设备中写入数据 push data into device
     *
     * @param characteristic 蓝牙特征值
     * @return true or false
     */
    ...
    /**
     * 获取gatt服务列表 // nhan danh sach dich vu GATT
     *
    ...
    public boolean connect(final String address) {
        ...
        if (device == null) {
            Log.e("e","蓝牙设备没有发现，无法连接。");// khong the ket noi
            return false;
        }
    ...
    /**
     * 连接状态接口 // interface state connection
     */
    ...
    /**
     * 发现服务、数据读写操作接口 //Khám phá dịch vụ, đọc dữ liệu và giao diện hoạt động
     */
