...
//    public final static String BACK = "2";
    ...
    public final static String XUNJI_START = "D201FFFF"; // XunJi = ngay
    ...
    public final static String OPTION_XIAOLIAN = "E101FFFF"; // xiaolian = mặt cười :))
    public final static String OPTION_JVSANG = "E102FFFF"; // bực bội
    public final static String OPTION_XIANGSHANG = "E103FFFF"; // buồn bã
    public final static String OPTION_XIANGXIA = "E104FFFF"; // nông thôn
    public final static String OPTION_XIANGZUO = "E105FFFF"; // muốn làm
    public final static String OPTION_XIANGYOU = "E106FFFF"; // thưởng thức
    public final static String OPTION_HUANGSE = "E107FFFF"; // màu vàng
    public final static String OPTION_LANSE = "E108FFFF"; // xanh da troi
    public final static String OPTION_LVSE = "E109FFFF"; // xanh la
    public final static String OPTION_HONGSE = "E110FFFF"; // mau do
    public final static String OPTION_ZISE = "E111FFFF"; // mau tim
    public final static String OPTION_BAISE = "E112FFFF"; // mau trang
    public final static String OPTION_FENSESE = "E113FFFF"; // mau hong
    public final static String OPTION_CLOSE_AGB = "E114FFFF";
    public final static String OPTION_CLOSE_DIANZHEN ="E115FFFF"; // mang tinh the :))
